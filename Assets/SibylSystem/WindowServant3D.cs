...
//    {
//        base.hide();
//        Program.shiftCameraPan(Program.I().camera_main_3d, false);
//    }

//    public override void show()
//    {
//        base.show();
//        Program.shiftCameraPan(Program.I().camera_main_3d, true);
//    }
...
//    {
//        gameObject.transform.localPosition = Program.I().camera_main_3d.ScreenToWorldPoint(new Vector3(Screen.width / 2, Screen.height * 1.5f, 1000));
//    }
...
//            gameObject.transform.localPosition = Program.I().camera_main_3d.ScreenToWorldPoint(new Vector3(Screen.width / 2, Screen.height / 2, 500));
//        }
//    }
...
//            (
//            mod,
//            Program.I().camera_main_3d.ScreenToWorldPoint(new Vector3(Screen.width / 2, Screen.height * 1.5f, 600)),
//            new Vector3(60, 0, 0),
//            false,
